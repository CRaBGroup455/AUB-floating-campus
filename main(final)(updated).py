...
def Window1():
    ...
    def firstFrame():
        ...
        if result == 1:  # if the user picked "student", then the interface of the student is initialized
            ...
            def Back2():        # command function for back button
                window2.destroy()
                Window1()

            btn4 = Button(window2, text="Back", command=Back2)      # Back Button
            ...
            btn5 = Button(window3, text="Upload link to students", command=Upload)
            btn5.grid(column=0, row=2)
            btn6 = Button(window3, text="Access AUB libraries", command=Research)
            btn6.grid(column=1, row=2)

            def Back3():            # command function for back button
                window3.destroy()
                Window1()

            btn7 = Button(window3, text="Back", command=Back3)
            ...
            btn8 = Button(window4, text="Student Affairs")
            btn8.grid(column=0, row=1)
            btn9 = Button(window4, text="Check Parking lot")
            btn9.grid(column=1, row=1)

            def Back4():            # command function for back button
                window4.destroy()
                Window1()

            btn10 = Button(window4, text="Back", command=Back4)
